...
"use strict";
eval("\n\n/**\n * Check if we're required to add a port number.\n *\n * @see https://url.spec.whatwg.org/#default-port\n * @param {Number|String} port Port number we need to check\n * @param {String} protocol Protocol we need to check against.\n * @returns {Boolean} Is it a default port for the given protocol\n * @api private\n */\nmodule.exports = function required(port, protocol) {\n  protocol = protocol.split(':')[0];\n  port = +port;\n\n  if (!port) return false;\n\n  switch (protocol) {\n    case 'http':\n    case 'ws':\n    return port !== 80;\n\n    case 'https':\n    case 'wss':\n    return port !== 443;\n\n    case 'ftp':\n    return port !== 21;\n\n    case 'gopher':\n    return port !== 70;\n\n    case 'file':\n    return false;\n  }\n\n  return port !== 0;\n};\n\n\n//# sourceURL=webpack://typescript-code-generator/./node_modules/requires-port/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar Console = /** @class */ (function () {\n    function Console() {\n    }\n    Console.parseArgs = function (args) {\n        return args.map(function (arg) {\n            if (Array.isArray(arg)) {\n                return \"Array: [\".concat(arg, \"]\");\n            }\n            else if (typeof arg === 'object') {\n                return \"Object: \".concat(Console.stringifyWithCyclicSupport(arg));\n            }\n            else {\n                return arg;\n            }\n        });\n    };\n    Console.stringifyWithCyclicSupport = function (object) {\n        var seen = [];\n        return JSON.stringify(object, function (key, val) {\n            if (val != null && typeof val == \"object\") {\n                if (seen.indexOf(val) >= 0) {\n                    return;\n                }\n                seen.push(val);\n            }\n            return val;\n        }, 2);\n    };\n    Console.log = function () {\n        var args = [];\n        for (var _i = 0; _i < arguments.length; _i++) {\n            args[_i] = arguments[_i];\n        }\n        console.log.apply(console, Console.parseArgs(args));\n    };\n    Console.error = function () {\n        var args = [];\n        for (var _i = 0; _i < arguments.length; _i++) {\n            args[_i] = arguments[_i];\n        }\n        console.error.apply(console, Console.parseArgs(args));\n    };\n    return Console;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Console);\n\n\n//# sourceURL=webpack://typescript-code-generator/./src/lib/console.ts?");
